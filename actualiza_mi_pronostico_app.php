			  ...
			  if (mysql_num_rows($consulta_p) == 1)
				...
				echo "<tr bgcolor='".$trcolor."'>
					  ...
					  <tr bgcolor='".$trcolor."'>
			  		    ...
			  		    <td align='right'><img src='images/escudos/".$renglon_juego['EquipoLocal'].".png' style='width:7vw;'></td>
					    <td align='center'>
						  <input type='text' 
					    ...
					    <td align='center'>
			  		    ...
			  		    <td align='left'><img src='images/escudos/".$renglon_juego['EquipoVisitante'].".png'  style='width:7vw;'></td>
					  ...
					  <tr bgcolor='".$trcolor."' align='center'>
						<td colspan='10' ><input type='text' readonly='readonly' name='txtPuntos-".$renglon_juego['IDJuego']."' value='$PtsP' size='1' style='background-color:#CCC;text-align:center;'></td>
					  </tr>";
